...
authorities <- data.frame(authority_name = c('Bolton', 'Bury', 'Oldham', 'Rochdale', 'Stockport', 'Tameside',
                                             ...
                                             'Warrington', 'Blackburn with Darwen', 'Cheshire East', 'High Peak',
                                             'Chorley', 'Rossendale', 'West Lancashire', 'St. Helens', 'Calderdale', 'Kirklees'),
                          authority_id   = c(24, 42, 191, 209, 260, 270,
                                             286, 313, 155, 220,
                                             295, 20, 445, 128,
                                             61, 211, 307, 256, 43, 140),
                          stringsAsFactors = F)
...
for (i in 1:length(years)){
  ...
  for (j in 1:nrow(authorities)) {
    ...
    print(paste0(year, ' - ', authorities[j,'authority_name']))
